...
import { Crosshair, ShieldCheck, Cpu, Compass, Sliders, ArrowRight } from "lucide-react";
...
const STORY_STEPS: StoryStep[] = [
  {
    ...
    specs: [
      { label: "MATERIAL", value: "T1000 Forged Carbon" },
  ...
  },
  {
    ...
    stepNumber: "02",
    title: "THE EYE",
    subtitle: "1-INCH DUAL-NATIVE ISO 8K OPTICS",
    ...
    specs: [
      { label: "SENSOR RESOLUTION", value: "8K 60FPS / 4K 120FPS" },
...
export default function ProductBreakdown() {
  ...
  return (
    <section
      id="story"
      className="relative w-full min-h-screen py-24 sm:py-32 px-4 sm:px-8 max-w-7xl mx-auto flex flex-col justify-between select-none"
    >
      {/* Header telemetry */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center my-auto">
        ...
        <div className="lg:col-span-7 relative flex items-center justify-center min-h-[380px] sm:min-h-[500px]">
          ...
          {/* Product Image with Animated Transform on Step Change */}
          <motion.div
            key={step.id}
          ...
          >
            ...
            >
              ...
              <span className="hidden sm:inline-block px-2.5 py-1 rounded-md bg-black/80 border border-white/20 text-[9px] font-mono font-bold tracking-widest text-white backdrop-blur-md whitespace-nowrap shadow-lg">
                {step.hotspot.label}
              </span>
            </div>
          </motion.div>
        ...
        {/* Step Breakdown & Technical Telemetry (Right 5 Cols) */}
        <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
          ...
          <div className="pt-4 border-t border-white/10 flex items-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-full text-black font-extrabold text-xs tracking-[0.2em] uppercase flex items-center gap-2 shadow-lg transition-transform hover:scale-105"
              style={{ backgroundColor: config.accent }}
            >
